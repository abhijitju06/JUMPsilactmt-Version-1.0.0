...
1. We can quantify proteins from multiple batches of samples generated by SILAC-TMT-LC/LC-MS/MS process. <br>
2. In addition to that, we can estimate free lysine decay from this data if experimental free lysine information is not available. 
</div>
